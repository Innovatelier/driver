#ifndef _PIB_PCIE_LWIF_H
#define _PIB_PCIE_LWIF_H

#include <linux/cdev.h>
#include <linux/pci.h>
#include "pib_pcie_lwif_cmd.h"

#define ALTERA_PCIE_DRIVER_NAME    "PIB PCIE LWIF"
#define ALTERA_PCIE_DEVFILE        "pib_pcie_lwif"
